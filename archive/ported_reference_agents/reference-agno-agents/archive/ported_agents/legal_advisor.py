...
class LegalAdvisorAgent:
    ...
    async def run_task(self, task: str) -> Dict[str, Any]:
        ...
        logger.info(f"🚀 Starting task for LegalAdvisor...")
        ...
        # logger.debug(content) # Avoid spamming logs with full content unless debug
        full_response.append(content)

        return {
            "response": "".join(full_response),
            "steps": [] # Future: Extract steps from MCP tools
        }
