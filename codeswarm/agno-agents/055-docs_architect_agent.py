...
SYSTEM_PROMPT_FILE = Path(__file__).with_name("docs_architect_sysp.json")

logger = logging.getLogger("DocsArchitect")
...
class DocsArchitectAgent:
    ...
    async def setup_agent(self):
        ...
        description = str(self.context.get("description") or "Creates comprehensive technical documentation from existing codebases. Analyzes architecture, design patterns, and implementation details to produce long-form technical manuals and ebooks. Use PROACTIVELY for system documentation, architecture guides, or technical deep-dives.")
    ...
    async def run_task(self, task: str) -> str:
        ...
        print(f"🚀 Starting task for DocsArchitect...")
        print(f"📝 Task: {task}")
        print("-" * 70 + "\n")
...
async def main():
    ...
    log_file = setup_logging(log_filename_prefix="DocsArchitect", verbose=args.verbose)
    print(f"🗒️  Log saved to: {log_file}")
    
    agent_instance = DocsArchitectAgent()
