...
SYSTEM_PROMPT_FILE = Path(__file__).with_name("tech_lead_orchestrator_sysp.json")

logger = logging.getLogger("TechLeadOrchestrator")
...
class TechLeadOrchestratorAgent:
    def __init__(self):
        self.model = None
        self.agent = None
        self.mcp_tools = None
    ...
    async def setup_agent(self):
        ...
        description = str(self.context.get("description") or "Senior technical lead who analyses complex software projects and provides strategic recommendations. Coordinates multi-agent workflows and delegates tasks to appropriate specialists. Use explicitly for complex multi-step development tasks requiring coordination.")
    ...
    async def run_task(self, task: str) -> str:
        ...
        print(f"🚀 Starting task for TechLeadOrchestrator...")
        print(f"📝 Task: {task}")
        print("-" * 70 + "\n")
...
async def main():
    parser = argparse.ArgumentParser(description="Senior technical lead who analyses complex software projects and provides strategic recommendations. Coordinates multi-agent workflows and delegates tasks to appropriate specialists. Use explicitly for complex multi-step development tasks requiring coordination.")
    parser.add_argument("--task", required=True, help="The task for the agent to perform.")
    parser.add_argument("--timeout", type=int, default=600, help="Timeout in seconds.")
    parser.add_argument("--verbose", action="store_true", help="Enable verbose logging.")
    args = parser.parse_args()

    log_file = setup_logging(log_filename_prefix="TechLeadOrchestrator", verbose=args.verbose)
    print(f"🗒️  Log saved to: {log_file}")
    
    agent_instance = TechLeadOrchestratorAgent()
    ...
    report_header = f"""
# Agent Report: TechLeadOrchestrator
